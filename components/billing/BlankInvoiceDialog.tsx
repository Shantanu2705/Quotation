...
import { Loader2, Download, UserCircle } from "lucide-react";
        ...
        >
          ...
          <div className="mb-12">
            <h3 className="text-sm mb-3 uppercase tracking-wider" style={headingStyle}>
              <UserCircle size={18} /> BILL TO
            </h3>
            <p className="text-lg font-bold uppercase m-0" style={{ color: "#d97706" }}>{formData.customerName || "Customer Name"}</p>
            {formData.address && <p className="m-0 uppercase mt-1" style={{ color: "#1e3a8a" }}>{formData.address}</p>}
          </div>
          ...
          <table className="w-full text-left border-collapse mb-12">
            ...
            <tbody>
              <tr>
                <td className="py-4 px-4" style={{ color: "#1e3a8a", borderBottom: "1px solid #b8860b" }}>{formData.serviceDescription || "Service"}</td>
          ...
          <div className="flex justify-between items-end mt-12 mb-8 pt-8" style={{ borderTop: "1px solid #b8860b" }}>
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-2xl font-black" style={{ color: "#1e3a8a" }}>₹ {Number(formData.amount || 0).toLocaleString("en-IN")}/-</span>
              </div>
            ...
            <div className="text-center flex flex-col items-center">
              <img src="/stamp.png" crossOrigin="anonymous" alt="Digital Dictionary Stamp" style={{ width: "160px", height: "auto", transform: "rotate(-10deg)" }} className="mb-2" />
